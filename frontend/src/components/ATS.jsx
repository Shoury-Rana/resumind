    ...
    return (
        <div className={`bg-linear-to-b ${gradientClass} to-white rounded-2xl shadow-md w-full p-6`}>
                ...
                <div className="space-y-3">
                    {tips.map((suggestion, index) => (
                        <div key={index} className="flex items-start gap-3">
                            ...
                            />
                            <p className={suggestion.type === "good" ? "text-green-800" : "text-amber-800"}>
                                {suggestion.tip}
                            </p>
                        </div>
                    ))}
            ...
            <p className="text-gray-700 italic">
                Refining these points will improve your chances of getting past automated filters.
            </p>
        </div>
    );
};
